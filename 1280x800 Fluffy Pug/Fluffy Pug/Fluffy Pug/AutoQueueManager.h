...
public:
    int awakeTime = 1000 * 60 * 60 * 24; //Stay awake for 18 hours
    int sleepTime = 1000 * 60 * 60 * 1; //Sleep for 6 hours
    int playTime = 1000 * 60 * 60 * 5; //Play for 3 hours in a row
    int breakTime = 1000 * 60 * 60 * 0; //1 hour break

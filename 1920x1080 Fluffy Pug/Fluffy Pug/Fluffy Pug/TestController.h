...
class TestController {
    ...
    ImageData testAbilitiesActiveImage, testInGameDetectionImage, testItemActivesImage, testLevelUpImage, testShopAvailableImage, testShopItemsImage, testShopOpenImage, testEnemyTowerImage, testLevelUpDotImage, testUsedPotion, testOutsideImage, testHextechGunblade, testSelfChampion;

...
class BasicAI {
    ...
    double lastLevelUp;
    double lastShopBuy, lastShopOpenTap, lastShopCloseTap, lastShopBuying;
    double lastCameraFocus;
    double lastPlacedWard;
    double lastRunAwayClick, lastClickEnemyChamp, lastClickEnemyMinion, lastClickEnemyTower, lastClickAllyChampion, lastClickAllyMinion;
    double lastMoveMouse;
    double lastMovementClick;
    double lastRecallTap;
    double lastSpell1Use, lastSpell2Use, lastSpell3Use, lastSpell4Use, lastSummonerSpell1Use, lastSummonerSpell2Use;
    double lastItem1Use, lastItem2Use, lastItem3Use, lastItem4Use, lastItem5Use, lastItem6Use;
    
    
    double moveToLanePathSwitch;
    
    bool boughtStarterItems;
    NSMutableArray* boughtItems;
    double gameCurrentTime, lastSurrender, activeAutoUseTime;
    
    CGPoint baseLocation;
    
    float healthGainedPerSecond;
    double healthGainedTime;
    float lastHealthAmount;
    double lastHealthtimePassed;
    
    double standStillTime;
    
    double lastTimeSawEnemyChamp;
...
extern inline double mach_absolute_time( )
{

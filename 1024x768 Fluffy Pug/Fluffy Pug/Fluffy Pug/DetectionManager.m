...
DetectionManager::DetectionManager(dispatch_queue_t _aiThread, dispatch_queue_t _detectionThread) {
    ...
    itemActive1Thread = surrenderThread;
    itemActive2Thread =  surrenderThread;
    itemActive3Thread =  surrenderThread;
    itemActive4Thread =  surrenderThread;
    itemActive5Thread = surrenderThread;
    itemActive6Thread =  surrenderThread;
    
    mapThread =  surrenderThread;
    shopThread =  surrenderThread;
    shopAvailableThread =  surrenderThread;
    usedPotionThread =surrenderThread;
    trinketActiveThread = surrenderThread;
    spell1ActiveThread =  surrenderThread;
    spell2ActiveThread =  surrenderThread;
    spell3ActiveThread =  surrenderThread;
    spell4ActiveThread =  surrenderThread;
    summonerSpell1ActiveThread =  surrenderThread;
    summonerSpell2ActiveThread =  surrenderThread;
    levelUpDotsThread =  surrenderThread;
    spell1LevelUpThread =  surrenderThread;
    spell2LevelUpThread =  surrenderThread;
    spell3LevelUpThread =  surrenderThread;
    spell4LevelUpThread =  surrenderThread;
    allyMinionThread =  surrenderThread;
    enemyMinionThread =  surrenderThread;
    enemyChampionThread =  surrenderThread;
    allyChampionThread = surrenderThread;
    enemyTowerThread = surrenderThread;
    selfChampionThread = surrenderThread;
                ...
                for (int i = 0; i < [itemsCanBuy count]; i++) {
                    ...
                    for (int i2 = 0; i2 < [itemsCanBuy count]; i2++) {
                        if (i != i2) {
                            ...
                            if (abs(item2->topLeft.x - item->topLeft.x) <= 15.0 && abs(item2->topLeft.y - item->topLeft.y) <= 15.0) {
